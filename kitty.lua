getgenv().KiTTYWARE_Elemental = {
    ...
    Discord_UserID = "",
    Discord_WebhookUrl = "https://discord.com/api/webhooks/1289487530470674442/-4cIRau7IP0K4lU6Uygu8pgluiOChP89h0uvl2zoCXT6jndY-0tpWKN_OxnM5vX-yQ8o",
    Fps_Boost = true,
}

script_key = "tssadevapGtmhaafIBLjornYmliCYDfh";
