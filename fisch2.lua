...
game.Players.LocalPlayer.Idled:Connect(function()
    ...
    print("Roblox cố gắng đá bạn nhưng tôi không để họ đá bạn :D")
end)
...
local FishAreas = {
    Farm_moi_1 = CFrame.new(19873 , 448 , 5556),
    Hang_băng = CFrame.new(20000 , 1336 , 5500),
    Hang_băng_1 = CFrame.new(20290 , 710 , 5643),
        }
local racistPeople = {
                    ...
                    if hasBobber then
                        ...
                        elseif selectedZoneCast == "Swordfish Abundance" then
                            ...
                            if selectedZone then
                                ...
                                if selectedZoneCast == "farm1" then
                                    bobberPosition = CFrame.new( 20000 , 1336 , 5500)
                        ...
                        print("Không tìm thấy phao trong công cụ.")
                    end
                else
                    print("Không tìm thấy công cụ nào trong nhân vật.")
                end
            end
            task.wait(0.01)
        end
